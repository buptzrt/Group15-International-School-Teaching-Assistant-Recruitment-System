...
public class UserDao {
    ...
    private static final String FILE_PATH = "D:/DESKTOP/STUDY/THREE DOWN/SOFTWARE_ENG/ONLINE-PLACEMENT-MANAGEMENT-SYSTEM-MAIN/ONLINE-PLACEMENT-MANAGEMENT-SYSTEM-MAIN/data/users.json";
