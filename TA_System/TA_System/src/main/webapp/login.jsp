...
<head>
    ...
    <style>
        ...
        .admin-btn::after {
            content: "\1F9D1\200D\1F4BB"; /* professional */
        }

        .student-btn::after {
            content: "\1F9D1\200D\1F393"; /* student */
        }

        .mo-btn::after {
            content: "\1F9D1\200D\1F4BC"; /* office worker */
        }
...
<body>
    ...
    <div class="role-box">
        ...
        <a href="mo_login.jsp" class="btn mo-btn">MO Login</a>
    </div>
