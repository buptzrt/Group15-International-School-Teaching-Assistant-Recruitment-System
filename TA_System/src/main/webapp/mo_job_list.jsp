        ...
        <div class="toolbar">
            <div class="toolbar-left">
                <div class="search-wrap">
                    <input id="jobSearch" class="search-input" type="text" placeholder="Search visible columns (Course, Title, Type, Deadline, Position)...">
                    <button id="btnSearch" class="search-btn" type="button" title="Search">Search</button>
                </div>
                <span class="hint">Click a header to filter. Deadline supports "on or before selected date".</span>
            </div>
...
(function () {
    ...
    function buildSearchHay(row) {
        // Search only visible columns: Course, Title, Type, Deadline, Position
        const visibleCols = [];
        for (let i = 0; i <= 4; i++) {
    ...
    function openValueFilter(th) {
        const key = th.dataset.key;
        const colIndex = { course: 0, title: 1, type: 2, position: 4 }[key];
