...
<%
    ...
    if (jobs != null) {
        for (Job job : jobs) {
            ...
            // 🌟 实时累加所有岗位的空缺名额
            totalQuotaLeft += job.getNumberOfPositions();
        }
    }
%>
<!DOCTYPE html>
...
<div class="navbar">
    <div class="navbar-left">
        ...
        <a href="manage_jobs.jsp" style="background-color: #00b894;">Manage Jobs</a>
    </div>
</div>
...
<div class="container">
    ...
    <div class="total-display">
        Total Vacancy Quota (Across all jobs): <span><%= totalQuotaLeft %></span>
    </div>
