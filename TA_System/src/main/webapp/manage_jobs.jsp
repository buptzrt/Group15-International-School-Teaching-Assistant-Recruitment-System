...
<div class="container">
    ...
    <form action="AdminJobServlet" method="post">
        ...
        <div class="form-grid">
            <input name="moduleCode" required placeholder="Module Code" value="<%= editJob == null ? "" : editJob.getModuleCode() %>">
            <input name="courseName" required placeholder="Course Name" value="<%= editJob == null ? "" : editJob.getCourseName() %>">
            <input name="jobTitle" required placeholder="Job Title" value="<%= editJob == null ? "" : editJob.getJobTitle() %>">
            ...
            <input name="numberOfPositions" type="number" min="0" required placeholder="Quota" value="<%= editJob == null ? "1" : editJob.getNumberOfPositions() %>">
            <input name="applicationDeadline" type="date" required value="<%= editJob == null ? "" : editJob.getApplicationDeadline() %>">
            <input name="workingHours" placeholder="Working Hours" value="<%= editJob == null ? "" : (editJob.getWorkingHours() == null ? "" : editJob.getWorkingHours()) %>">
            <input name="semester" placeholder="Semester" value="<%= editJob == null ? "" : (editJob.getSemester() == null ? "" : editJob.getSemester()) %>">
            <input name="location" placeholder="Location" value="<%= editJob == null ? "" : (editJob.getLocation() == null ? "" : editJob.getLocation()) %>">
            <input name="requiredSkills" placeholder="Required Skills" value="<%= editJob == null ? "" : (editJob.getRequiredSkills() == null ? "" : editJob.getRequiredSkills()) %>">
            <input name="preferredMajor" placeholder="Preferred Major" value="<%= editJob == null ? "" : (editJob.getPreferredMajor() == null ? "" : editJob.getPreferredMajor()) %>">
            <input name="cgpaRequired" type="number" step="0.01" min="0" max="10" placeholder="Min CGPA" value="<%= editJob == null ? "" : editJob.getCgpaRequired() %>">
            <input name="contactEmail" placeholder="Contact Email" value="<%= editJob == null ? "" : (editJob.getContactEmail() == null ? "" : editJob.getContactEmail()) %>">
            <input name="contactPhone" placeholder="Contact Phone" value="<%= editJob == null ? "" : (editJob.getContactPhone() == null ? "" : editJob.getContactPhone()) %>">
            <input name="jobResponsibilities" placeholder="Responsibilities" value="<%= editJob == null ? "" : (editJob.getJobResponsibilities() == null ? "" : editJob.getJobResponsibilities()) %>">
        </div>
