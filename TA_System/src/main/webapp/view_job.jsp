...
<%
    ...
    // 防御：如果职位被删除了，提供安全的返回按钮
    if (currentJob == null) {
        out.println("<h2 style='color:#ff4d4d; text-align:center; margin-top:100px; font-family:sans-serif;'>Error: Job not found.</h2>");
        out.println("<div style='text-align:center;'><a href='MOJobServlet' style='color:#9bd3ff; text-decoration:none;'>&#8592; Return to Job List</a></div>");
        return;
    }
...
<div class="page-container">
    <div class="header">
        <div class="header-left">
            <a href="MOJobServlet" title="Back to Vacancy List">&#8592;</a>
    ...
    <div class="card">
        ...
        <div class="detail-grid">
            ...
            <div class="detail-item"><strong>Openings</strong><span><%= numberOfPositions %></span></div>
            <div class="detail-item"><strong>Application Deadline</strong><span><%= applicationDeadline %></span></div>
            <div class="detail-item"><strong>CGPA Requirement</strong><span><%= cgpaRequired %></span></div>
            <div class="detail-item"><strong>Preferred Major</strong><span><%= preferredMajor %></span></div>
            <div class="detail-item"><strong>Location / Mode</strong><span><%= location %></span></div>
        </div>
        <div class="description">
            <div class="section-title">Requirements & Conditions</div>
