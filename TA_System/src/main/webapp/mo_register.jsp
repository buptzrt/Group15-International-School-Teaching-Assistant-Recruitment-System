...
<body>
    ...
    <div class="page-stage">
        ...
        <div class="register-content">
            ...
            <h1 class="register-title">MO Register</h1>
            ...
            <form action="MORegisterServlet" method="post">
                <div class="input-group">
                    ...
                    <div class="input-item">
                        <label for="enrollment_no">MO ID:</label>
                        <input type="text" id="enrollment_no" name="enrollment_no" placeholder="eg: 2022212009" pattern="^202[0-6](212|213)\d{3}$" maxlength="10" inputmode="numeric" required title="Use 2020-2026 + 212/213 + any 3 digits.">
                        <div class="field-hint">please input valid MO ID.</div>
                    </div>
