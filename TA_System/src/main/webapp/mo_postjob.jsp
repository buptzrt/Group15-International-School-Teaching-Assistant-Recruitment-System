  ...
  <div class="job-grid">
    ...
    <div class="card">
      ...
      <div style="margin-top: 15px; display: flex; gap: 10px;">
        <a href="view_job.jsp?jobId=<%= job.getJobId() %>" class="btn" style="padding: 8px 12px; background-color: #17a2b8; text-decoration: none; text-align: center;">View</a>
  ...
  <div class="modal-content">
    ...
    <form id="jobForm" action="MOJobServlet" method="POST">
      ...
      <div style="display: flex; gap: 15px;">
        ...
        <div class="form-group" style="flex: 1;"><label>Application Deadline *</label><input type="date" id="form_applicationDeadline" name="applicationDeadline" required></div>
